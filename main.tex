...
To address this challege, a recent TREC LiveQA 2015 shared task (www.trec-liveqa.org) was started, where automated systems attempted to answer real users' questions within 1 minute. This task was successful, with the winning system able to automatically return a reasonable answer to more than half of the submitted questions. 
