...
To faciliate research on this challenge, a recent TREC LiveQA shared task (www.trec-liveqa.org) was started in 2015, where automated systems attempt to answer real users' questions within 1 minute.
