...
However, in such cases we can design a QA support system, which a worker can use in order to find some additional information.
For example, in our experiment we let workers use web search to find answers, if they were unfamiliar with the topic.
More efficient interfaces are definitely possible and we are planning to explore this direction in the future work.
